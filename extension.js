...
const {
    ...
    startLiveView, autoDiscoverConnect, refreshDevicesCommand, wirelessPairingQr,
...
async function activate(context) {
    ...
    const commands = [
        vscode.commands.registerCommand('wirelessDebug.refreshDevices', () => refreshDevicesCommand(provider)),
        ...
        vscode.commands.registerCommand('wirelessDebug.stopLogcat', (d) => d && stopLogcat(d)),
        ...
        vscode.commands.registerCommand('wirelessDebug.connectDiscovered', (d) => d && connectDiscoveredDevice(provider, d)),
    ];
